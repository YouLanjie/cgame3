...
int main() {
	...
	menu.title = "贪吃蛇游戏";
	menu.addText(&menu, "1.开始游戏", "2.游戏帮助", "3.游戏设置", NULL);
	menu.addTextData(&menu, 0, "%s%s%s", "%z开始贪吃蛇游戏%z", "%z查看游戏的全部帮助%z", "%z设置游戏的更新时间（更新间隔），分别为秒与微秒。延迟数字越大游戏速度越慢%z");

	help.title = "游戏帮助";
	help.cfg   = 2;
	help.addText(&help, "1.%z主界面可以使用%zWASD%z或者方向键再或%zvim%z键位移动选择的选项，并且按下空格或回车选择对应的选项光标移动到当页尽头后如果还有内容会翻页到下一页，右下角会有当前所在的页数和总页数的提示%z",
